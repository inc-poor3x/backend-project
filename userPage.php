...
<nav id="navbar" class="">
        <div class="nav-wrapper">
          ...
          <div class="logo">
            ...
            <input type="search" name="lala" id="lala" value="">
          </div>
   ...
   <!-- this section edits name and image -->
    ...
    $userId = '1'; //delete after making comment visible
    $sql = "SELECT username, img, email, date_of_birth FROM users WHERE id = '$userId'";
